 ...
 * @author Usuario
 */
@WebServlet(name = "MisPlanos", urlPatterns = {"/MisPlanos"})
public class MisPlanos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Blueprint> planos = bpservice.GetBlueprintsByUserId(cUser.getIdUser());
